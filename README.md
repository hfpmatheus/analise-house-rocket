...
<img src="https://www.mundi.com.br/rimg/dimg/72/59/d4891b32-city-7054-17745b4e13e.jpg?width=1366&height=768&xhint=1003&yhint=1402&crop=true" alt="drawing" width="66%"/>
...
- Interpreto “boas condições” como um imóvel que tenha nota maior ou igual a 3 na coluna “condition”.
...
- 3.1.2: Processo (passo a passo do que é preciso ser feito):
  ...
  - Criar nova coluna “recomendação no dataset”
  - Agrupar as casas por “zipcode” e tirar a mediana de seus preços.
  - Todas as casas que tiverem em boas condições e abaixo da mediana de preço do   seu zipcode, terão “compra” na coluna recomendação.
  - As que tiverem em boas condições, porém acima do preço, terão “não compre”
  - As que tiverem em más condições terão “baixa qualidade”
...
3.3. Descrição e Limpeza de Dados: 
...
R: **De fato, quando se compara a mediana de ambos o resultado é de que os mais caros tem 1 quarto a mais. Logo, uma boa sugestão para a empresa seria construir 1 quarto a mais nos imóveis comprados, pois isso aumentaria seu valor.**

##

Hipótese 2: Em média, imóveis baratos e com vista para a água tem 30% menos área total do que imóveis baratos que não tem vista para a água.
...
R: **Em média, os imóveis antigos são 20% mais baratos do que os mais novos. Uma sugestão seria modernizar a fachada dos mais antigos para aumentar seu valor de venda.**
